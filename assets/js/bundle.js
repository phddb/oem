...
function openModal() {
    $("body").css("overflow", "hidden"), $(".modal, .modal__overlay").show().css("display", "flex"), $(".modal__inner").velocity({
        translateY: 0,
        opacity: 1
    }), $(".modal__overlay").velocity({
        opacity: 1
    }, 100)
}
...
function formCheck() {
    $(".js-submit").click(function(e) {
        ...
        for (var i = 0; i < t.length; i++) {
            var o = t[i];
            $(o).attr("required", !0) && !validateRequired($(o).val()) && (addErrorData($(o), "This field is required"), r = !0), $(o).attr("required", !0) && "email" === $(o).attr("type") && !validateEmail($(o).val()) && (addErrorData($(o), "Email address is invalid"), r = !0), $(n).attr("required", !0) && !validateRequired($(n).val()) && (addErrorData($(n), "This field is required"), r = !0)
...
function(e) {
    ...
    $.ajax({
        ...
        success: function(e) {
            n.val(""), r.val(""), t.prop("disabled", !1), t.text("Send"), openModal(), $(".modal__body").append("<h1>Thanks " + i + "!</h1><p>Your message was successfully sent! Will get back to you soon.</p>")
        },
        error: function(e) {
            $(".modal, .modal__overlay").addClass("--show"), $(".modal__body").append("<h1>Aww snap!</h1><p>Something went wrong, please try again. Error message:</p>" + e)
        }
    })
});